...
class ForgotEmailTest extends IsolatedAccountTestCase
{
    protected function setUp(): void
    {
        ...
        // The 'forgot-email' throttle is active during tests. Clear only its
        // key so each test starts with a clean counter without flushing shared
        // cache state used by other parallel test workers.
        RateLimiter::clear(md5('forgot-email127.0.0.1'));
    }
