 ...
 */
class DeleteInactivePlayersCommandTest extends IsolatedAccountTestCase
{
    ...
    /**
     * Create an additional user inside this test's isolated database transaction.
     *
     * @param array<string, mixed> $attributes
     */
    private function createAdditionalUser(array $attributes = []): User
    {
    ...
    public function testDeletesInactivePlayerButKeepsActivePlayer(): void
    {
        ...
        $activeUser = $this->createAdditionalUser();
     ...
     */
    public function testDeletionPermanentlyRemovesPlanetsAndPreservesReports(): void
    {
        $this->setDeletionDays(35);
